...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="superBrief" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']"
    priority="2">
    <xsl:variable name="langId" select="gn-fn-iso19139.sdn-cdi:getLangId(., $lang)"/>
  ...
  <xsl:template name="iso19139.sdn-cdiBrief">
    <metadata>
      <xsl:call-template name="iso19139.sdn-cdi-brief"/>
    </metadata>
  </xsl:template>

  <xsl:template name="iso19139.sdn-cdi-brief">
